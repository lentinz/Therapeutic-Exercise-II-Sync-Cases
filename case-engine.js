  ...
  return `
    ...
    <div class="panel dim">
      ...
      <ul style="padding-left:20px; margin:0;">
        ...
        <li style="margin-bottom:8px;">Within the objective exam, sections unlock one at a time, in order \u2014 you\u2019ll need to fully complete one section before the next becomes available.</li>
